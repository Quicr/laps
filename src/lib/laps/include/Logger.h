...
public:
  ...
  /*********************************************************************/ /**
                                                                           ...
                                                                           *
                                                                           ***********************************************************************/
  void DebugPrint(const char *filename, int line_num, const char *func_name,
                  const char *msg, ...);
...
private:
  ...
  u_char
      width_filename; ///< Defines the width of the filename field when printed
   ...
   *                          IF NULL, then the filename and line number will
   * not be included \param [in]  line_num    the line number from the file that
   * originated the debug message \param [in]  func_name   function name of the
   * calling function \param [in]  msg         message to print, can contain
   * sprintf formats \param [in]  args        variable list of args for vfprintf
   */
