...
namespace laps {
    QuicrClientManager::QuicrClientManager(State& state,
                                           const Config& config,
    ...
    void QuicrClientManager::NewConnectionAccepted(quicr::ConnectionHandle connection_handle,
    ...
    std::vector<quicr::ConnectionHandle> QuicrClientManager::PublishNamespaceDoneReceived(
    ...
    void QuicrClientManager::PurgePublishState(quicr::ConnectionHandle connection_handle)
    {
    ...
    void QuicrClientManager::PublishNamespaceReceived(quicr::ConnectionHandle connection_handle,
    ...
    void QuicrClientManager::PublishReceived(
      quicr::ConnectionHandle connection_handle,
      uint64_t request_id,
    ...
    void QuicrClientManager::SubscribeNamespaceReceived(quicr::ConnectionHandle connection_handle,
    ...
    void QuicrClientManager::UnsubscribeNamespaceReceived(quicr::ConnectionHandle connection_handle,
                                                          const quicr::TrackNamespace& prefix_namespace)
    {
    ...
    void QuicrClientManager::ConnectionStatusChanged(quicr::ConnectionHandle connection_handle, ConnectionStatus status)
    {
        switch (status) {
    ...
    quicr::Server::ClientSetupResponse QuicrClientManager::ClientSetupReceived(
    ...
    void QuicrClientManager::PublishDoneReceived(quicr::ConnectionHandle connection_handle, uint64_t request_id)
    {
        SPDLOG_LOGGER_INFO(
    ...
    void QuicrClientManager::UnsubscribeReceived(quicr::ConnectionHandle connection_handle, uint64_t request_id)
    {
    ...
    void QuicrClientManager::RemoveOrPausePublisherSubscribe(quicr::TrackFullNameHash track_fullname_hash)
    {
    ...
    void QuicrClientManager::TrackStatusReceived(quicr::ConnectionHandle connection_handle,
                                                 uint64_t request_id,
    ...
    void QuicrClientManager::SubscribeReceived(quicr::ConnectionHandle connection_handle,
                                               uint64_t request_id,
                                               const quicr::FullTrackName& track_full_name,
    ...
    std::optional<quicr::messages::Location> QuicrClientManager::GetLargestAvailable(
    ...
    void QuicrClientManager::FetchReceived(quicr::ConnectionHandle connection_handle,
                                           uint64_t request_id,
                                           const quicr::FullTrackName& track_full_name,
                                           uint8_t priority,
    ...
    void QuicrClientManager::StandaloneFetchReceived(quicr::ConnectionHandle connection_handle,
                                                     uint64_t request_id,
                                                     const quicr::FullTrackName& track_full_name,
    ...
    void QuicrClientManager::JoiningFetchReceived(quicr::ConnectionHandle connection_handle,
                                                  uint64_t request_id,
                                                  const quicr::FullTrackName& track_full_name,
    ...
    void QuicrClientManager::FetchCancelReceived(quicr::ConnectionHandle connection_handle, uint64_t request_id)
    {
    ...
    void QuicrClientManager::NewGroupRequested(const quicr::FullTrackName& track_full_name,
    ...
    bool QuicrClientManager::DampenOrUpdateTrackSubscription(
