...
build-prep: CMakeLists.txt
	cmake -S . -B${BUILD_DIR}  -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DBUILD_TESTING=OFF -DLAPS_BUILD_TESTS=OFF -DCMAKE_BUILD_TYPE=Release
...
## publish-image-arm64: Publish arm64 image to ECR
